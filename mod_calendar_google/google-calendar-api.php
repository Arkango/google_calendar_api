...
class GoogleCalendarApi
{
	...
	/*********************************************************************************/
	public function GetCalendarEvents($calendar_id,$access_token,$from = false,$to = false){
			$url_parameters = array();
			if($from){
		...
		/*********************************************************************************/
		public function GetEventsInfo($calendar_id,$access_token,$event_id){
	...
	public function CreateCalendarEvent($calendar_id, $summary, $all_day, $event_time, $event_timezone, $access_token,$description,$location) {
		$url_events = 'https://www.googleapis.com/calendar/v3/calendars/' . $calendar_id . '/events';

		$curlPost = array('summary' => $summary,'description' => $description,'location' => $location);
		if($all_day == 1) {
