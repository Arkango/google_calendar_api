...
if($_SESSION['access_token'] == 1 || !isset($_SESSION['access_token']['access_token'])) {
...
$evento =  $capi->GetEventsInfo($_SESSION['calendar_id'],$_SESSION['access_token']['access_token'],$evento_id);
...
<div id="form-container">
	<input type="text" id="event-title" value="<?php echo $evento['summary']; ?>" placeholder="Event Title" autocomplete="off" />
	<select id="event-type"  autocomplete="off">
		<option value="0">Fixed Time Event</option>
		<option value="1">All Day Event</option>
	</select>
	<input type="text" id="event-start-time" value="<?php echo $evento['start']['dateTime']; ?>" placeholder="Event Start Time" autocomplete="off" />
	<input type="text" id="event-end-time" value="<?php echo $evento['end']['dateTime']; ?>" placeholder="Event End Time" autocomplete="off" />
	<input type="text" id="event-date" value="<?php echo $evento['start']['date']; ?>" placeholder="Event Date" autocomplete="off" />
	<input type="text" id="event-location"  value="<?php echo $evento['location']; ?>" placeholder="Event Location" autocomplete="off" />
	<input type="text" id="event-description" value="<?php echo $evento['description']; ?>" placeholder="Event Description" autocomplete="off" />
	<button id="create-update-event" data-operation="update" data-event-id="<?php echo $evento_id; ?>">Update Event</button>
